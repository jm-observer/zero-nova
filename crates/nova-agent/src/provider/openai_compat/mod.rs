...
impl OpenAiCompatClient {
    ...
    /// 仅当字段 trim 后非空时才注入，不注入空串或仅空白值。
    fn build_request_headers(request_context: &ProviderRequestContext) -> Vec<(String, String)> {
...
mod tests {
    ...
    #[test]
    fn test_build_request_headers_both_fields() {
