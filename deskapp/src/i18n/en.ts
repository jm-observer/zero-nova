...
const en: Record<string, string> = {
    ...
    'console.current_run': 'Current Run',
    'console.run_history': 'Run History',
    'console.select_run': 'Select a run to inspect details',
    'console.pending_permissions': 'Pending Requests',
    'console.no_pending_permissions': 'No pending permission requests',
    'console.audit_logs': 'Audit Logs',
    'console.no_audit_logs': 'No audit logs yet',
    'console.workspace_restore': 'Workspace Restore',
    'console.no_restore': 'No restorable context',
    'console.current_diagnostics': 'Current Diagnostics',
    'console.no_diagnostics': 'No diagnostic issues',
    'console.filter_all': 'All',
    'console.filter_running': 'Running',
    'console.filter_waiting': 'Waiting',
    'console.filter_failed': 'Failed',
    'console.filter_artifacts': 'Has Artifacts',
    'console.action_stop': 'Stop',
    'console.action_resume': 'Resume',
    'console.action_open': 'Preview',
    'console.action_reveal': 'Reveal File',
    'console.action_copy_path': 'Copy Path',
    'console.action_copy_content': 'Copy Content',
    'console.action_go_run': 'Go to Run',
    'console.action_go_permission': 'Go to Permission',
    'console.action_go_settings': 'Open Settings',
    'console.action_restore_view': 'Restore View',
    'console.action_retry': 'Retry',
    'console.section_steps': 'Step Timeline',
    'console.section_artifacts': 'Artifacts',
    'console.section_relations': 'Issues / Permissions / Audit',
    'console.label_waiting_reason': 'Waiting Reason',
    'console.label_model': 'Model',
    'console.label_duration': 'Duration',
    'console.label_tools': 'Tool Calls',
    'console.label_tokens': 'Tokens',
    'console.label_artifacts': 'Artifacts',
    'console.restore_view_only': 'View-only restore',
    'console.restore_reattachable': 'Run can be reattached',
    'console.restore_missing_session': 'Saved session no longer exists. Reset to a safe default view.',
    'console.permission_scope_session': 'Session',
    'console.permission_scope_agent': 'Agent',
    'console.permission_scope_global': 'Global',
    'console.permission_remember': 'Remember this decision',
    'console.permission_approved': 'Approved',
    'console.permission_denied': 'Denied',
    'console.permission_pending': 'Pending',
    'console.audit_action_failed': 'Host action failed',
    'console.artifact_missing': 'Artifact file is missing or inaccessible',
    'console.restore_applied': 'Workspace context restored',
    'console.restore_unsupported': 'Gateway restore is unsupported. Only local view state was restored.',
    ...
    'console.memory_approximate': 'Approximate matches shown, not actual injected content',
    'skills.runtime': 'runtime',
    'console.backend_upgrade_required': 'This feature requires a newer Gateway version',
};
