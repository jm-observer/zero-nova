...
const zh: Record<string, string> = {
    ...
    'console.tab_permissions': '权限',
    'console.tab_diagnostics': '诊断',
    ...
    'console.current_run': '当前运行',
    'console.run_history': '运行历史',
    'console.select_run': '请选择一条运行记录',
    'console.pending_permissions': '待确认请求',
    'console.no_pending_permissions': '当前没有待确认请求',
    'console.audit_logs': '审计日志',
    'console.no_audit_logs': '暂无审计记录',
    'console.workspace_restore': '工作区恢复',
    'console.no_restore': '暂无可恢复上下文',
    'console.current_diagnostics': '当前诊断',
    'console.no_diagnostics': '当前没有诊断问题',
    'console.filter_all': '全部',
    'console.filter_running': '运行中',
    'console.filter_waiting': '等待确认',
    'console.filter_failed': '失败',
    'console.filter_artifacts': '有产物',
    'console.action_stop': '停止',
    'console.action_resume': '继续',
    'console.action_open': '预览',
    'console.action_reveal': '定位文件',
    'console.action_copy_path': '复制路径',
    'console.action_copy_content': '复制内容',
    'console.action_go_run': '跳转运行',
    'console.action_go_permission': '跳转权限',
    'console.action_go_settings': '打开设置',
    'console.action_restore_view': '恢复视图',
    'console.action_retry': '重试',
    'console.section_steps': '步骤时间线',
    'console.section_artifacts': '关联产物',
    'console.section_relations': '关联异常 / 权限 / 审计',
    'console.label_waiting_reason': '等待原因',
    'console.label_model': '模型',
    'console.label_duration': '耗时',
    'console.label_tools': '工具调用',
    'console.label_tokens': 'Token',
    'console.label_artifacts': '产物',
    'console.restore_view_only': '仅查看历史上下文',
    'console.restore_reattachable': '可重新附着当前运行',
    'console.restore_missing_session': '恢复记录中的会话已失效，已回退默认视图',
    'console.permission_scope_session': '本会话',
    'console.permission_scope_agent': '当前 Agent',
    'console.permission_scope_global': '全局',
    'console.permission_remember': '记住本次选择',
    'console.permission_approved': '已批准',
    'console.permission_denied': '已拒绝',
    'console.permission_pending': '待处理',
    'console.audit_action_failed': '宿主动作失败',
    'console.artifact_missing': '产物文件不存在或无法访问',
    'console.restore_applied': '已恢复上次工作区上下文',
    'console.restore_unsupported': '当前 Gateway 不支持工作区恢复，仅恢复本地视图',
    ...
    'console.memory_approximate': '以下为近似匹配结果，非实际注入内容',
    'skills.runtime': '运行中',
    'console.backend_upgrade_required': '该功能需要后端 Gateway 升级',
};
