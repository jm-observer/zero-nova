...
| Plan | 描述 | 依赖 | 顺序 | 状态 |
|---|---|---|---|---|
| Plan 1 | 上下文模型与协议接口扩展 | 无 | 1 | 待开始 |
| Plan 2 | OpenAI 兼容 Provider Header 注入实现 | Plan 1 | 2 | 待开始 |
| Plan 3 | 调用链路接入与开关配置落地 | Plan 1, Plan 2 | 3 | 待开始 |
| Plan 4 | 测试、验证与发布回归 | Plan 1, Plan 2, Plan 3 | 4 | 待开始 |
